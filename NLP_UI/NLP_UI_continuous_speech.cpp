...
recognize_from_microphone()
{
    ...
    for (;;) {
        ...
        ps_end_utt(ps);
        hyp = ps_get_hyp(ps, NULL, &uttid);
        printf("This is the uttered word:%s: %s\n", uttid, hyp);
        fflush(stdout);
...
sf::RenderWindow window(sf::VideoMode(400,400),"NLP_GAME_UI");
    ...
    int vel_x=0,vel_y=0,x=10,y=10,move_speed=2,sprite_x=0,sprite_y=0;
